...
namespace sstocker.budget.Helpers
{
    public static class AccountHelper
    {
        ...
        public static string GetImage(string image = null)
        {
            return string.IsNullOrWhiteSpace(image)
                ? $"data:image/jpeg;base64,{DefaultAccountImage}"
